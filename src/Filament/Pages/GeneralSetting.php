...
class GeneralSetting extends SettingsPage
{
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                Schemas\Components\Tabs::make('general_setting_tabs')
                    ->tabs([
                        Schemas\Components\Tabs\Tab::make(__('sn-cms::cms.general_setting.site_section'))
                        ...
                        Schemas\Components\Tabs\Tab::make(__('sn-cms::cms.general_setting.seo_section'))
                        ...
                        Schemas\Components\Tabs\Tab::make(__('sn-cms::cms.general_setting.basic_info'))
                            ...
                            ->schema([
                                Schemas\Components\Section::make()
                                    ...
                                    ->columns(2)
                                    ->columnSpanFull(),
                                Schemas\Components\Section::make(__('sn-cms::cms.general_setting.qrcode_section'))
                                    ->schema([
                        ...
                        Schemas\Components\Tabs\Tab::make(__('sn-cms::cms.general_setting.legal_section'))
