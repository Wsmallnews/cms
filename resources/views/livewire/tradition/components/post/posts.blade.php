...
{{-- 自含容器：响应类在根元素上，容器查询看祖先，故外包一层 @container（跨模块复用时无需外部提供容器上下文）。
    组件自带侧栏分栏用容器断点（组件可能被编排进窄槽）：容器 @5xl(1024px) 起并排 1:3，@6xl 起内容 4 格；容器不足时上下堆叠（分类树在上） --}}
<div class="w-full @container">
    <div class="w-full flex flex-col @5xl:grid @5xl:grid-cols-4 @6xl:grid-cols-5 sn-gap relative">
        ...
        <div @class([
            ...
            '@5xl:col-span-3 @6xl:col-span-4' => $categoryStyle == 'tree',
            '@5xl:col-span-4 @6xl:col-span-5' => $categoryStyle != 'tree',
        ])>
                    ...
                    <div class="w-full flex flex-col divide-y divide-gray-100 dark:divide-gray-800/70">
                        @forelse ($posts as $post)
                            ...
                            >
                                ...
                                <div class="flex flex-col grow min-w-0 gap-1 @2xl:gap-1.5">
                                    {{-- 顶行：分类标签（左）+ flag 标识（右）--}}
