...
{{-- 自含容器：轮播形态开关（@4xl:flex-row）在根元素上，外包 @container 使组件跨模块复用时自带容器上下文 --}}
<div class="w-full @container">
    <div class="w-full flex flex-col @4xl:flex-row sn-gap">
        ...
        <div @class([
            'sn-container sn-hover' => $contained,
            'w-full flex flex-col @4xl:grid @4xl:grid-rows-4 @4xl:aspect-video overflow-hidden sn-divide-y'
        ])>
                ...
                @if ($loop->index >= $listStartIndex)
                    ...
                    >
                        ...
                        <div class="min-w-0 flex flex-col grow py-2 sn-px gap-1">
                            ...
                            <div class="sn-descript-text @4xl:h-0 @5xl:h-auto grow line-clamp-2 @5xl:line-clamp-1 @6xl:line-clamp-2">
                                {{ $post->description }}
                            </div>
